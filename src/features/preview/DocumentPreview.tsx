  ...
  useEffect(() => {
    const updateScale = () => {
      if (containerRef.current && contentRef.current) {
        ...
        // Calculer le scale pour la largeur et la hauteur
        const scaleX = (containerWidth - 40) / contentWidth
        const scaleY = (containerHeight - 40) / contentHeight

        // Prendre le plus petit des deux pour que tout rentre (contain)
        ...
        >
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                {headerSection.data.legalForm && (
                  <div style={{ fontSize: '9px', marginBottom: '2px', color: '#4b5563' }}>
              ...
              {linesSection.data.length === 0 ? (
                ...
                >
                  ...
                  >
                    ...
                    >
                      "Ajoute (une ligne pour) l’installation de telle ou telle prestation"
                    </div>
                  </div>
                </div>
              ) : (
          ...
          {totalsSection && (
            <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'flex-end' }}>
              <div style={{ minWidth: '250px' }}>
                ...
                >
                  <span style={{ fontSize: '10px', color: '#4b5563' }}>Total HT</span>
                  <span style={{ fontSize: '10px', fontWeight: 'bold', color: '#111827' }}>
                ...
                {totalsSection.data.vatNotApplicable ? (
                  ...
                  >
                    <span style={{ fontSize: '10px', color: '#4b5563' }}>TVA non applicable</span>
                    <span style={{ fontSize: '10px', fontWeight: 'bold', color: '#111827' }}>
                      Art. 293 B du CGI
                    </span>
                  </div>
          ...
          {customSection && (
            ...
            >
              ...
              <div style={{ fontSize: '8px', color: '#4b5563', lineHeight: '1.4' }}>
