...
export const DocumentPreview = ({ data, contentRef }: DocumentPreviewProps) => {
    ...
    >
      ...
      {totalsSection && (
        <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'flex-end' }}>
          <div style={{ minWidth: '250px' }}>
            ...
            >
              <span style={{ fontSize: '10px', color: colors.textSecondary }}>Sous-total HT</span>
      ...
      {legalSection && (
        ...
        >
          ...
          >
            • Indemnité forfaitaire de recouvrement : {legalSection.data.recoveryFee} € (art. L441-6
